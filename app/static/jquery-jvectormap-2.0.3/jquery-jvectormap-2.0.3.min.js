...
jvm.MultiMap.prototype = {
            ...
            that.maps[name] ? that.maps[name].params.container.show() : that.addMap(name, {
                ...
                series:{
                  regions: [{
                    scale: ['#b2dfdb', '#00897b'],
                    attribute: 'fill',
                    values: countyTotalLoan,
                    min: countyTotalLoanValues[name]['min'],
                    max: countyTotalLoanValues[name]['max']
                  }]
                },
                regionStyle: {
                              initial: {
                ...
                selectedRegions: goodCounties[name],
                onRegionTipShow: function(e, el, code){
                  var dat = countyData.reduce(function(acc, line){
                    var res = {};
                    if (line.Geo_Code ==  code) {
    ...
    goBack: function() {
        ...
        currentMap.setFocus({
            ...
            prevMap.setFocus({
                regions:['US-DC', 'US-DE', 'US-MD', 'US-VA', 'US-WV', 'US-NC', 'US-PA'],
                scale: 1,
                animate: !0
            })
        })
